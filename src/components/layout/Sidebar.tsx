...
import { LayoutDashboard, Calculator, ShoppingBag, Target, TrendingUp, LogOut, Clock, ShieldAlert } from 'lucide-react';
...
const SIDEBAR_LINKS = [
  ...
  { to: '/client/portfolio', icon: ShieldAlert, label: 'Carteira AFIC 🔒' },
